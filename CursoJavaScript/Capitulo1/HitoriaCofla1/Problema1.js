...
if(MontoCofla >= 0.6 && MontoCofla < 1){
    document.write("Cofla puede comprar helado de agua"+"<br>");
    MontoCofla-=0.6;
    document.write("Tu vuelto es: "+MontoCofla);
}else if (MontoCofla >= 1 && MontoCofla < 1.6){
    document.write("Cofla puede comprar helado de crema"+"<br>");
    MontoCofla-=1;
    document.write("Tu vuelto es: "+MontoCofla);
}else if (MontoCofla >= 1.6 && MontoCofla < 1.7){
    document.write("Cofla puede comprar bombon helado marca heladix"+"<br>");
    MontoCofla-=1.6;
    document.write("Tu vuelto es: "+MontoCofla);
}else if (MontoCofla >= 1.7 && MontoCofla < 1.8){
    document.write("Cofla puede comprar bombon helado marca heladon"+"<br>");
    MontoCofla-=1.7;
    document.write("Tu vuelto es: "+MontoCofla);
}else if (MontoCofla >= 1.8 && MontoCofla < 2.9){
    document.write("Cofla puede comprar bombon helado marca heladisimo"+"<br>");
    MontoCofla-=1.8;
    document.write("Tu vuelto es: "+MontoCofla);
}else if (MontoCofla >= 2.9){
    document.write("Cofla puede comprar potecito de helado con confites o  un pote de 1/4kg"+"<br>");
    MontoCofla-=2.9;
    document.write("Tu vuelto es: "+MontoCofla);
}else{
