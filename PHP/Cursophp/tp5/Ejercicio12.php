<?php
    ...
    class Alumno{
        ...
        public function obtenerEstado():EstadoAlumno{
            if(count($this->listaNotas)== 0) return EstadoAlumno::Ausente;
            $promedio = $this->calcularPromedio();
            if($promedio >= 6){
                return EstadoAlumno::Aprobado;
            }
            return EstadoAlumno::Desaprobado;
        }
    }
